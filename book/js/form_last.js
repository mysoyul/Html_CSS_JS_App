    ...
    if (book.bookDetail) {
        detailHTML += `
            <div class="book-detail-item">
                ...
                <div class="book-detail-value">${book.bookDetail.description || '-'}</div>
            </div>
            <div class="book-detail-item">
                <div class="book-detail-label">언어</div>
                <div class="book-detail-value">${book.bookDetail.language || '-'}</div>
            </div>
            <div class="book-detail-item">
                <div class="book-detail-label">페이지 수</div>
                <div class="book-detail-value">${book.bookDetail.pageCount || '-'}</div>
            </div>
            <div class="book-detail-item">
                <div class="book-detail-label">출판사</div>
                <div class="book-detail-value">${book.bookDetail.publisher || '-'}</div>
            </div>
            <div class="book-detail-item">
                <div class="book-detail-label">에디션</div>
                <div class="book-detail-value">${book.bookDetail.edition || '-'}</div>
            </div>
        `;
        
        if (book.bookDetail.coverImageUrl) {
            detailHTML += `
                <div class="book-detail-item">
                    <div class="book-detail-label">표지 이미지</div>
                    <div class="book-detail-value">
                        <img src="${book.bookDetail.coverImageUrl}" alt="표지 이미지" class="cover-image">
                    </div>
                </div>
            `;
        }
